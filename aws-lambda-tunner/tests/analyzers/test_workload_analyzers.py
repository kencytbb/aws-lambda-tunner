...
def on_demand_memory_results():
    ...
    return {
        128: MemoryTestResult(
            ...
            errors=1,
            raw_results=[
                {'duration': 2500, 'cost': 0.0000002, 'is_cold_start': True, 'concurrent_executions': 1},
                {'duration': 1500, 'cost': 0.0000002, 'is_cold_start': False, 'concurrent_executions': 1},
                {'duration': 2800, 'cost': 0.0000002, 'is_cold_start': True, 'concurrent_executions': 1},
                {'duration': 1600, 'cost': 0.0000002, 'is_cold_start': False, 'concurrent_executions': 1},
                {'duration': 2600, 'cost': 0.0000002, 'is_cold_start': True, 'concurrent_executions': 1},
                {'duration': 1700, 'cost': 0.0000002, 'is_cold_start': False, 'concurrent_executions': 1},
                {'duration': 2700, 'cost': 0.0000002, 'is_cold_start': True, 'concurrent_executions': 1},
                {'duration': 1500, 'cost': 0.0000002, 'is_cold_start': False, 'concurrent_executions': 1},
                {'duration': 2500, 'cost': 0.0000002, 'is_cold_start': True, 'concurrent_executions': 1},
                {'duration': 1600, 'cost': 0.0000002, 'is_cold_start': False, 'concurrent_executions': 1}
            ]
        ...
        256: MemoryTestResult(
            ...
            errors=0,
            raw_results=[
                {'duration': 2200, 'cost': 0.0000003, 'is_cold_start': True, 'concurrent_executions': 1},
                {'duration': 1400, 'cost': 0.0000003, 'is_cold_start': False, 'concurrent_executions': 1},
                {'duration': 2300, 'cost': 0.0000003, 'is_cold_start': True, 'concurrent_executions': 1},
                {'duration': 1500, 'cost': 0.0000003, 'is_cold_start': False, 'concurrent_executions': 1},
                {'duration': 2100, 'cost': 0.0000003, 'is_cold_start': True, 'concurrent_executions': 1},
                {'duration': 1600, 'cost': 0.0000003, 'is_cold_start': False, 'concurrent_executions': 1},
                {'duration': 2000, 'cost': 0.0000003, 'is_cold_start': True, 'concurrent_executions': 1},
                {'duration': 1400, 'cost': 0.0000003, 'is_cold_start': False, 'concurrent_executions': 1},
                {'duration': 1500, 'cost': 0.0000003, 'is_cold_start': False, 'concurrent_executions': 1},
                {'duration': 1600, 'cost': 0.0000003, 'is_cold_start': False, 'concurrent_executions': 1}
            ]
        ...
        512: MemoryTestResult(
            ...
            errors=0,
            raw_results=[
                {'duration': 1800, 'cost': 0.0000004, 'is_cold_start': True, 'concurrent_executions': 1},
                {'duration': 1300, 'cost': 0.0000004, 'is_cold_start': False, 'concurrent_executions': 1},
                {'duration': 1900, 'cost': 0.0000004, 'is_cold_start': True, 'concurrent_executions': 1},
                {'duration': 1400, 'cost': 0.0000004, 'is_cold_start': False, 'concurrent_executions': 1},
                {'duration': 1500, 'cost': 0.0000004, 'is_cold_start': False, 'concurrent_executions': 1},
                {'duration': 1600, 'cost': 0.0000004, 'is_cold_start': False, 'concurrent_executions': 1},
                {'duration': 1400, 'cost': 0.0000004, 'is_cold_start': False, 'concurrent_executions': 1},
                {'duration': 1500, 'cost': 0.0000004, 'is_cold_start': False, 'concurrent_executions': 1},
                {'duration': 1300, 'cost': 0.0000004, 'is_cold_start': False, 'concurrent_executions': 1},
                {'duration': 1500, 'cost': 0.0000004, 'is_cold_start': False, 'concurrent_executions': 1}
...
def continuous_memory_results():
    ...
    return {
        128: MemoryTestResult(
            ...
            errors=2,
            raw_results=[
                {'duration': d, 'cost': 0.0000002, 'is_cold_start': False, 'concurrent_executions': c, 
                 'cpu_utilization': 0.8, 'memory_utilization': 0.9} 
                for d, c in zip(
        ...
        256: MemoryTestResult(
            ...
            errors=1,
            raw_results=[
                {'duration': d, 'cost': 0.0000003, 'is_cold_start': False, 'concurrent_executions': c,
                 'cpu_utilization': 0.7, 'memory_utilization': 0.8}
                for d, c in zip(
                    [1000, 980, 1020, 990, 1010] * 10,
                    [12, 15, 18, 20, 22] * 10
                )
            ]
        ),
        512: MemoryTestResult(
            ...
            errors=0,
            raw_results=[
                {'duration': d, 'cost': 0.0000005, 'is_cold_start': False, 'concurrent_executions': c,
                 'cpu_utilization': 0.6, 'memory_utilization': 0.7}
                for d, c in zip(
                    [800, 790, 810, 795, 805] * 10,
                    [15, 18, 20, 22, 25] * 10
                )
            ]
        )
...
def scheduled_memory_results():
    ...
    return {
        128: MemoryTestResult(
            ...
            errors=0,
            raw_results=[
                {'duration': 1500 + (i % 3) * 10, 'cost': 0.0000002, 'is_cold_start': False, 
                 'concurrent_executions': 2 + (i % 2), 'timestamp': 1000 + i * 100}
        ...
        256: MemoryTestResult(
            ...
            errors=0,
            raw_results=[
                {'duration': 1200 + (i % 2) * 5, 'cost': 0.0000003, 'is_cold_start': False,
                 'concurrent_executions': 3 + (i % 2), 'timestamp': 1000 + i * 100}
                for i in range(20)
            ]
        ),
        512: MemoryTestResult(
            ...
            errors=0,
            raw_results=[
                {'duration': 1000 + (i % 2) * 2, 'cost': 0.0000005, 'is_cold_start': False,
                 'concurrent_executions': 4 + (i % 2), 'timestamp': 1000 + i * 100}
                for i in range(20)
            ]
        )
    }
...
class TestOnDemandAnalyzer:
    ...
    def test_analyze_for_minimal_cold_starts(self, mock_config, on_demand_memory_results):
        ...
        worst_memory = max(on_demand_memory_results.keys(), 
                          key=lambda k: on_demand_memory_results[k].cold_starts / on_demand_memory_results[k].iterations)
    ...
    def test_user_experience_impact_rating(self, mock_config):
        ...
        moderate_impact = analyzer._rate_user_experience_impact(0.1, 200)  # 10% ratio, 200ms penalty
        significant_impact = analyzer._rate_user_experience_impact(0.2, 500)  # 20% ratio, 500ms penalty
        severe_impact = analyzer._rate_user_experience_impact(0.5, 1000)  # 50% ratio, 1000ms penalty
...
class TestContinuousAnalyzer:
    ...
    def test_sustained_performance_metrics(self, mock_config, continuous_memory_results):
        ...
        sustained_metrics = analyzer._calculate_sustained_performance_metrics(continuous_memory_results)
    ...
    def test_resource_utilization_efficiency(self, mock_config, continuous_memory_results):
        ...
        utilization_analysis = analyzer._analyze_resource_utilization_efficiency(continuous_memory_results)
...
class TestScheduledAnalyzer:
    ...
    def test_cost_performance_sweet_spot(self, mock_config, scheduled_memory_results):
        ...
        balanced_efficiency = analyzer._calculate_balanced_efficiency_scores(scheduled_memory_results)
        sweet_spot = analyzer._find_cost_performance_sweet_spot(scheduled_memory_results, balanced_efficiency)
    ...
    def test_resource_allocation_recommendations(self, mock_config, scheduled_memory_results):
        ...
        for rec in recommendations:
            ...
            assert rec["type"] in ["memory_allocation", "concurrency_allocation", "cost_consideration", "monitoring"]
...
class TestWorkloadAnalyzerIntegration:
    ...
    def test_workload_specific_optimizations(self, mock_config, on_demand_memory_results, 
                                           continuous_memory_results, scheduled_memory_results):
        ...
        continuous_rec = continuous_analyzer.get_continuous_recommendation(continuous_memory_results)
        ...
        assert "cold start" in on_demand_rec.reasoning.lower() or "latency" in on_demand_rec.reasoning.lower()
        assert "throughput" in continuous_rec.reasoning.lower() or "cost" in continuous_rec.reasoning.lower()
        assert "balance" in scheduled_rec.reasoning.lower() or "efficiency" in scheduled_rec.reasoning.lower()
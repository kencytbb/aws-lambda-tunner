...
from aws_lambda_tuner.report_service import (
    ReportGenerator, WorkloadType, TrafficPattern
)
...
class TestEnhancedReportGeneration:
            ...
            'configurations': [
                {
                    'memory_mb': 128,
                    'executions': [
                        {'duration': 1500, 'billed_duration': 1500, 'cold_start': True, 'error': None},
                ...
                },
                {
                    'memory_mb': 256,
                    'executions': [
                        {'duration': 900, 'billed_duration': 900, 'cold_start': True, 'error': None},
                ...
                },
                {
                    ...
                    'executions': [
                        ...
                        {'duration': 250, 'billed_duration': 300, 'cold_start': False, 'error': None},
                    ]
                }
            ]
        }
    ...
    def test_traffic_pattern_cost_adjustments(self, report_generator):
        ...
        for pattern, expected_multiplier in patterns:
            projection = report_generator._calculate_cost_projection(
                optimal, 1000, pattern, 30
            )
        ...
        comparisons = [
            {
                ...
                'analysis': {'key_metrics': {'optimal_memory': 256}}
            },
            {

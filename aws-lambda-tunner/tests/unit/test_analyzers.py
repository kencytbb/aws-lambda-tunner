...
class TestPerformanceAnalyzer:
    ...
    @pytest.mark.parametrize("workload_type", ['cpu_intensive', 'io_bound', 'memory_intensive', 'balanced'])
    ...
    def test_cold_start_analysis(self, analyzer, sample_results_data):
        ...
        cold_start_insights = [i for i in analysis.insights 
...
class TestAnalyzerParametrized:
    ...
    @pytest.mark.parametrize("memory_sizes,expected_trend", [
    ...
    def test_different_error_rates(self, analyzer, error_rate):
        ...
        if error_rate >= 0.2:
            reliability_insights = [i for i in analysis.insights 

...
class TestPerformanceAnalysis:
    ...
    def test_performance_analysis_validation(self, sample_memory_results, validator):
        ...
        assert validator.validate_performance_analysis(analysis, expected_memory_sizes=[256, 512, 1024])
...
class TestTuningResult:
    ...
    def test_tuning_result_creation(self, sample_memory_results, sample_performance_analysis, sample_recommendation):
    ...
    def test_tuning_result_with_baseline(self, sample_memory_results, sample_performance_analysis, sample_recommendation):
...
@pytest.mark.unit
@pytest.mark.parametrize("memory_size,expected_valid", [
    (128, True),
    (256, True),
    (512, True),
    (1024, True),

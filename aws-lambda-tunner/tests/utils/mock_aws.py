...
class MockLambdaClient:
    ...
    def _generate_log_result(self, duration: float = None, billed_duration: int = None, 
                           memory_size: int = None, cold_start: bool = False, 
...
class MockCloudWatchClient:
    ...
    def get_metric_statistics(self, **kwargs) -> Dict[str, Any]:
        ...
        return {
            'Label': kwargs.get('MetricName', 'Duration'),

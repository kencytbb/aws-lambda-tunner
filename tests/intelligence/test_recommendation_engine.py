...
from aws_lambda_tuner.intelligence.recommendation_engine import (
...
class TestIntelligentRecommendationEngine:
    ...
    def test_generate_intelligent_recommendation(
        self, sample_config, sample_memory_results, sample_analysis
    ):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            engine.cost_predictor.predict_costs_for_memory = Mock(
                return_value={"cost_per_invocation": 0.000002, "monthly_cost": 60.0}
            )

            recommendation = engine.generate_intelligent_recommendation(
                sample_analysis, sample_memory_results
            )

...
class TestOptimizationPerformance:
    ...
    def test_single_function_optimization_performance(
        self, orchestrator, mock_aws_services, performance_helpers
    ):
    ...
    def test_large_memory_range_performance(
        self, orchestrator, mock_aws_services, performance_helpers
    ):
    ...
    def test_high_iteration_count_performance(
        self, orchestrator, mock_aws_services, performance_helpers
    ):
    ...
    def test_concurrent_execution_performance(
        self, orchestrator, mock_aws_services, performance_helpers
    ):
...
class TestScalabilityPerformance:
    ...
    def test_multiple_function_optimization_performance(
        self, orchestrator, mock_aws_services, performance_helpers
    ):
    ...
    def test_parallel_function_optimization_performance(
        self, orchestrator, mock_aws_services, performance_helpers
    ):
        ...
        with ThreadPoolExecutor(max_workers=3) as executor:
            future_results = [
                executor.submit(optimize_function, config) for config in function_configs
            ]
    ...
    def test_memory_config_count_scaling(
        self, orchestrator, mock_aws_services, performance_helpers, num_memory_configs
    ):
    ...
    def test_iteration_count_scaling(
        self, orchestrator, mock_aws_services, performance_helpers, iteration_count
    ):
...
class TestStressPerformance:
    ...
    @pytest.mark.slow
    def test_extreme_memory_range_stress(
        self, orchestrator, mock_aws_services, performance_helpers
    ):
    ...
    @pytest.mark.slow
    def test_high_iteration_stress(self, orchestrator, mock_aws_services, performance_helpers):
...
class TestBenchmarkComparisons:
    ...
    def test_strategy_performance_comparison(
        ...
        if "comprehensive" in strategy_times:
            ...
            assert (
                comprehensive_time <= avg_other_time * 2

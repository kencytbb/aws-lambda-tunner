...
class TestVisualizationEngine:
            ...
            'configurations': [
                {
                    'memory_mb': 128,
                    'executions': [
                        {'duration': 1500, 'billed_duration': 1500, 'cold_start': True, 'error': None, 'timestamp': '2024-01-01T12:00:00Z'},
                        {'duration': 800, 'billed_duration': 900, 'cold_start': False, 'error': None, 'timestamp': '2024-01-01T12:01:00Z'},
                        {'duration': 850, 'billed_duration': 900, 'cold_start': False, 'error': None, 'timestamp': '2024-01-01T12:02:00Z'},
                        {'duration': 900, 'billed_duration': 900, 'cold_start': False, 'error': None, 'timestamp': '2024-01-01T12:03:00Z'},
                        {'duration': 780, 'billed_duration': 800, 'cold_start': False, 'error': None, 'timestamp': '2024-01-01T12:04:00Z'},
                    ]
                },
                {
                    'memory_mb': 256,
                    'executions': [
                        {'duration': 900, 'billed_duration': 900, 'cold_start': True, 'error': None, 'timestamp': '2024-01-01T12:00:00Z'},
                        {'duration': 400, 'billed_duration': 500, 'cold_start': False, 'error': None, 'timestamp': '2024-01-01T12:01:00Z'},
                        {'duration': 450, 'billed_duration': 500, 'cold_start': False, 'error': None, 'timestamp': '2024-01-01T12:02:00Z'},
                        {'duration': 380, 'billed_duration': 400, 'cold_start': False, 'error': None, 'timestamp': '2024-01-01T12:03:00Z'},
                        {'duration': 420, 'billed_duration': 500, 'cold_start': False, 'error': None, 'timestamp': '2024-01-01T12:04:00Z'},
                    ]
                },
                {
                    'memory_mb': 512,
                    'executions': [
                        {'duration': 600, 'billed_duration': 600, 'cold_start': True, 'error': None, 'timestamp': '2024-01-01T12:00:00Z'},
                        {'duration': 200, 'billed_duration': 300, 'cold_start': False, 'error': None, 'timestamp': '2024-01-01T12:01:00Z'},
                        {'duration': 250, 'billed_duration': 300, 'cold_start': False, 'error': None, 'timestamp': '2024-01-01T12:02:00Z'},
                        {'duration': 180, 'billed_duration': 200, 'cold_start': False, 'error': None, 'timestamp': '2024-01-01T12:03:00Z'},
                        {'duration': 220, 'billed_duration': 300, 'cold_start': False, 'error': None, 'timestamp': '2024-01-01T12:04:00Z'},
                    ]
                }
            ]
        }
    ...
    def test_comprehensive_dashboard(self, viz_engine, temp_dir):
        ...
        scenarios = [
            {'name': 'production', 'daily_invocations': 50000, 'pattern': 'seasonal'}
        ]
            ...
            'configurations': [
                {
                    ...
                    'executions': [
                        # Only cold starts
                        {'duration': 1000, 'billed_duration': 1000, 'cold_start': True, 'error': None},
                        {'duration': 1100, 'billed_duration': 1100, 'cold_start': True, 'error': None},
                    ]
                },
                {
                    'memory_mb': 256,
                    'executions': [
                        # Only warm starts
                        {'duration': 400, 'billed_duration': 500, 'cold_start': False, 'error': None},
                        {'duration': 450, 'billed_duration': 500, 'cold_start': False, 'error': None},
                    ]
                },
                {
                    'memory_mb': 512,
                    'executions': [
                        # Mix with errors
                        {'duration': 200, 'billed_duration': 300, 'cold_start': False, 'error': None},
                        {'duration': 0, 'billed_duration': 0, 'cold_start': False, 'error': 'timeout'},
                    ]
                }
            ]
        }
...
class TestInteractiveDashboards:
            ...
            'configurations': [
                {
                    ...
                    'executions': [
                        {'duration': 1000, 'billed_duration': 1000, 'cold_start': True, 'error': None},
                        {'duration': 800, 'billed_duration': 900, 'cold_start': False, 'error': None},
                        {'duration': 850, 'billed_duration': 900, 'cold_start': False, 'error': None},
                    ]
                },
                {
                    'memory_mb': 256,
                    'executions': [
                        {'duration': 600, 'billed_duration': 600, 'cold_start': True, 'error': None},
                        {'duration': 400, 'billed_duration': 500, 'cold_start': False, 'error': None},
                        {'duration': 450, 'billed_duration': 500, 'cold_start': False, 'error': None},
                    ]
                }
    ...
    def test_cost_analysis_dashboard_creation(self, dashboard, temp_dir):
        ...
        scenarios = [
            ...
            {'name': 'High Volume', 'daily_invocations': 100000, 'pattern': 'bursty', 'duration_days': 30}
        ]
    ...
    def test_dashboard_customization_options(self, dashboard, temp_dir):
        ...
        workload_types = ['web_api', 'batch_processing', 'event_driven', 'scheduled', 'stream_processing', 'generic']
        ...
        for workload_type in workload_types:
            ...
            with open(output_path, 'r') as f:
                ...
                assert workload_type.replace('_', ' ').title() in content or 'Performance Dashboard' in content
...
class TestConvenienceFunctions:
            ...
            'configurations': [
                {
                    'memory_mb': 256,
                    'executions': [
                        {'duration': 500, 'billed_duration': 500, 'cold_start': False, 'error': None}
                    ]
                }
            ]
        }
    ...
    @patch('aws_lambda_tuner.reporting.interactive_dashboards.InteractiveDashboard.create_performance_dashboard')
    def test_create_interactive_performance_dashboard(self, mock_create, sample_results):
        ...
        from aws_lambda_tuner.reporting.interactive_dashboards import create_interactive_performance_dashboard

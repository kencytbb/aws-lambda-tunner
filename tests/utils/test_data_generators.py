...
class TestDataGenerator:
    ...
    def generate_memory_test_result(
        self, memory_size: int, iterations: int = 10, workload_type: str = "balanced"
    ) -> MemoryTestResult:
        ...
        for i in range(iterations):
            execution = self.generate_execution_result(memory_size, i, workload_type)
...
def generate_memory_test_result(
    memory_size: int, iterations: int = 10, workload_type: str = "balanced"
) -> MemoryTestResult:
